    ...
    var h = function (w) {
        ...
        u.forEach(function (B, z, C) {
            ...
            B.pivot.forEach(function (E) {
                ...
                x.push({
                    label: D.replace(/^([A-Z])(\w+)(.+)$/, "$1.$3").replace(/sensu lato/, "sl").replace(/chromosomal form/, "cf"),
                    value: F,
...
function loadSmall(h, e, l) {
    ...
    f.BuildLeafletCluster = function (o, n) {
        ...
        i.on("click", function () {
            ...
            for (var p in q) {
                m.push({
                    label: p.replace(/^([A-Z])(\w+)(.+)$/, "$1.$3").replace(/sensu lato/, "sl").replace(/chromosomal form/, "cf"),
                    value: q[p],
