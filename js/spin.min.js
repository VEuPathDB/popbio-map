(function (a, b) {
    ...
    k(b.prototype, {
        spin: function (z) {
            this.stop();
            var C = this, r = C.opts, s = C.el = f(g(0, {className: r.className}), {
                position: r.position,
                width: 0,
                zIndex: r.zIndex
            }), B = r.radius + r.length + r.width;
            f(s, {left: r.left, top: r.top});
            if (z) {
            ...
            if (!o) {
                ...
                (function u() {
                    w++;
                    for (var D = 0; D < r.lines; D++) {
                        v = Math.max(1 - (w + (r.lines - D) * A) % y * x, r.opacity);
                        C.opacity(s, D * r.direction + q, v, r)
                    }
                    C.timeout = C.el && setTimeout(u, ~~(1000 / t))
                })()
            }
            return C
        }, stop: function () {
