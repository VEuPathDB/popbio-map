(function (PopulationBiologyMap, $, undefined) {
   ...
   PopulationBiologyMap.init = function() {
    ...
    PopulationBiologyMap.methods.createProjectSelect = function(divid, filter) {
        ...
        var abundanceUrl = "/popbio/qsolr/solr/vb_popbio/query?";
        var queryParameters = "q=has_abundance_data_b:true%20AND%20-sample_size_i:0&rows=0&wt=json&facet=true&facet.mincount=1&facet.field=projects_category&fq=bundle:pop_sample";
        var queryUrl = abundanceUrl + queryParameters + filter; // + "&json.wrf=?&callback=?";
            ...
            success: function (json) {
                ...
                if (projects_list && Object.keys(projects_list).length > 0) {
                    setTimeout(function () {
                        ...
                        var queryParameters = query + "&rows=0&wt=json";
                        ...
                        $.ajax({
                            ...
                            complete: function() {
                                ...
                                data = PopulationBiologyMap.data.highcharts[project_id];
