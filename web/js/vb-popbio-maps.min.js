function loadSolr(e) {
    ...
    var b = "http://funcgen.vectorbase.org/popbio-map-preview/asolr/solr/vb_popbio/smplGeoclust?" + qryUrl + buildBbox(map.getBounds()) + "&stats.facet=" + g + "&facet.pivot=" + g + ",species_category&json.wrf=?&callback=?";
    map.spin(true);
...
function loadSmall(g, f) {
    ...
    var a = "http://funcgen.vectorbase.org/popbio-map-preview/asolr/solr/vb_popbio/smplMarkers?" + qryUrl + "&fq=" + h + ":" + d + buildBbox(map.getBounds()) + "&json.wrf=?&callback=?";
    map.spin(true);
    $.getJSON(a, b)
}
