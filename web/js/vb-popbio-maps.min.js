        ...
        var s = {
            ...
            onEachRecord: function (x, w) {
                ...
                x.on("click", function () {
                    ...
                    createBeeViolinPlot(d3.select("#swarm-chart"), buildBbox(y), w.count)
                });
...
function loadSmall(g, f) {
    ...
    e.BuildLeafletCluster = function (k, j) {
        ...
        i.on("click", function () {
            ...
            for (var m in n) {
                l.push({
                    label: m.replace(/sensu lato/, "sl").replace(/chromosomal form/, "cf"),
                    value: n[m],
                    color: (palette[m] ? palette[m] : "#000000")
                })
            }
            updatePieChart(k.population, l)
        });
