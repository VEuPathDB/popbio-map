        ...
        var u = {
            ...
            onEachRecord: function (z, y) {
                ...
                z.on("click", function () {
                    ...
                    timer = setTimeout(function () {
                        if (!prevent) {
                            ...
                            var B = L.latLngBounds(y.bounds);
                            createBeeViolinPlot("#swarm-chart-area", buildBbox(B));
                            updateTable("#table-contents", buildBbox(B))
                        }
                    }, delay);
                    prevent = false
                });
                z.on("mouseover", function () {
                    ...
                    rectHighlight = L.rectangle(A, {color: "#cyan", weight: 5, fill: true, clickable: false}).addTo(map)
                });
...
function loadSmall(g, f) {
    ...
    e.BuildLeafletCluster = function (k, j) {
        ...
        i.on("mouseover", function () {
            ...
            rectHighlight = L.rectangle(m, {color: "#cyan", weight: 5, fill: true, clickable: false}).addTo(map)
        });
...
function resetPlots() {
    ...
    if (firstClick) {
        ...
        a = '<div style="text-align: center; margin-top: 30px"><i class="fa fa-table" style="color: #2c699e; font-size: 12em"></i><h1>Go on!</h1><h3>click a marker</h3><h3>to see some real data</h3> </div>'
    } else {
        ...
        a = '<div style="text-align: center; margin-top: 30px"><i class="fa fa-table" style="color: #2c699e; font-size: 12em"></i><h3>click a marker</h3></div>'
    }
    $("#graphs").html(b);
