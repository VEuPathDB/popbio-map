...
function resetPlots() {
    if (highlight !== null) {
        ...
        var b = '<h3>Sample summary data</h3><div id="pie-chart-header" style="text-align: center; margin-top: 30px"><i class="fa fa-pie-chart" style="color: #2c699e; font-size: 12em"></i><h1>Go on!</h1><h3>click a marker</h3><h3>to plot some real data</h3> </div><div id="pie-chart-area"><svg></svg></div>';
        var c = '<div style="text-align: center; margin-top: 30px"><i class="fa fa-area-chart" style="color: #2c699e; font-size: 12em"></i><h1>Go on!</h1><h3>click a marker</h3><h3>to plot some real data</h3> </div>';
        var a = '<div style="text-align: center; margin-top: 30px"><i class="fa fa-th-list" style="color: #2c699e; font-size: 12em"></i><h1>Go on!</h1><h3>click a marker</h3><h3>to see some real data</h3> </div>'
    }
    $("#graphs").html(b);
